...
\newcommand{\vikszerzoKeresztnev}{Róbert}

\newcommand{\vikkonzulensAMegszolitas}{}
\newcommand{\vikkonzulensAVezeteknev}{Gódor}
\newcommand{\vikkonzulensAKeresztnev}{Győző}
...
\newcommand{\vikcim}{Posztkvantum-kriptográfia alkalmazása az IoT rendszerek biztonságának megerősítésére} % Cím
...
\includepdf[pages=-]{Kiraly_Robert_feladatkiiras_v1.pdf}
...
\include{content/protocol-theory}
\include{content/enviroment}
\include{content/measurement-methods}
\include{content/measurements}
\include{content/measurment-review}
